...
def problem_five(request):
    ...
    student = Student.objects.create(first_name="Sophia", last_name="Jean-Pierre", year=2022, gpa=4.0)
...
def bonus_problem(request):
  ...
  c = Course.objects.annotate(Count('instructor'))
  print(c[0].name)

  single_course = Count('course', filter=Q(course_instructor=1))
